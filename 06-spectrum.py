...
numpyKernel=numpy.roll(numpy.roll(numpy.pad(numpyKernel, [(0, numpyImage.shape[0]-3), (0, numpyImage.shape[1]-3)], 'constant'), 1, 0), 1, 1)
...
# lastly, the inverse of the fourier transform is used to retrieve the spatial representation of the image again
