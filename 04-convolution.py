...
gckernel=numpy.array([[0.00,0.25,0.00],[0.25,1.00,0.25],[0.00,0.25,0.00]], numpy.float32)

rckernel=numpy.array([[0.25,0.50,0.25],[0.50,1.00,0.50],[0.25,0.50,0.25]], numpy.float32)

bckernel=numpy.array([[0.25,0.50,0.25],[0.50,1.00,0.50],[0.25,0.50,0.25]], numpy.float32)
...
numpyOutput[:, :, 1]=cv2.filter2D(numpyOutput[:,:,1],ddepth=-1,kernel=gckernel,borderType=cv2.BORDER_DEFAULT)
numpyOutput[:, :, 0]=cv2.filter2D(numpyOutput[:,:,0],ddepth=-1,kernel=rckernel,borderType=cv2.BORDER_DEFAULT)
numpyOutput[:, :, 2]=cv2.filter2D(numpyOutput[:,:,2],ddepth=-1,kernel=bckernel,borderType=cv2.BORDER_DEFAULT)
